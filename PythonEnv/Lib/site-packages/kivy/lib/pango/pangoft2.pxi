...
cdef extern from "pango/pangoft2.h" nogil:
    ...
    void pango_ft2_font_map_set_default_substitute(PangoFT2FontMap *fontmap, PangoFT2SubstituteFunc func, gpointer data,
...
cdef extern from "pango/pango-context.h" nogil:
    ...
    PangoFontMetrics *pango_context_get_metrics(PangoContext *context, const PangoFontDescription *desc,
