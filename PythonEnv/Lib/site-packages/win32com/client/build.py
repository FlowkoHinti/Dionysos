...
class DispatchItem(OleItem):
    ...
    def MakeDispatchFuncMethod(self, entry, name, bMakeClass=1):
        ...
        s = linePrefix + 'def ' + name + '(self' + BuildCallList(fdesc, names, defNamedOptArg, defNamedNotOptArg,
                                                                 defUnnamedArg, defOutArg) + '):'
        ret.append(s)
        if doc and doc[1]:
        ...
        bad_params = [flag for flag in param_flags if
