...
def Dispatch(IDispatch, userName=None, createClass=None, typeinfo=None, UnicodeToString=None,
...
class CDispatch:
    ...
    def _get_good_object_(self, ob, userName=None, ReturnCLSID=None):
        ...
        if ob is None:  # Quick exit!
            ...
            return tuple(
                map(lambda o, s=self, oun=userName, rc=ReturnCLSID: s._get_good_single_object_(o, oun, rc), ob))
        else:
