...
class OleClientSite:
    _public_methods_ = ['SaveObject', 'GetMoniker', 'GetContainer', 'ShowObject', 'OnShowWindow',
...
def test():
    ...
    lbcom = win32com.server.util.wrap(LockBytes(),
                                      pythoncom.IID_ILockBytes)  # , useDispatcher=win32com.server.dispatcher.DispatcherWin32trace)
