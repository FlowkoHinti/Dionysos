...
cdef extern from *:
    ...
    } slice_copy_contig "__pyx_memoryview_copy_new_contig"(
    ...
    bint slices_overlap "__pyx_slices_overlap"({
    {memviewslice_name
    }
    } *slice1,
    {
...
cdef class memoryview(object):
            ...
            for i in range(__pyx_memoryview_thread_locks_used):
                if __pyx_memoryview_thread_locks[i] is self.lock:
                    ...
                    if i != __pyx_memoryview_thread_locks_used:
                        __pyx_memoryview_thread_locks[i], __pyx_memoryview_thread_locks[
    ...
    cdef setitem_slice_assignment(self, dst, src):
        cdef {
        {memviewslice_name}} dst_slice
        cdef {
        {memviewslice_name}} src_slice
...
cdef int transpose_memslice({
{memviewslice_name}} *memslice) nogil except 0:
...
cdef {
{memviewslice_name}} *get_slice_from_memview(memoryview
memview,
...
cdef void slice_copy(memoryview memview, {
{memviewslice_name}} *dst):
cdef int dim
...
cdef memoryview_copy_from_slice(memoryview memview, {
{memviewslice_name}} *memviewslice):
"""
...
cdef char get_best_order({
{memviewslice_name}} *mslice, int
ndim) nogil:
"""
...
cdef void copy_strided_to_strided({
...
cdef void *copy_data_to_temp({
{memviewslice_name}} *src,
                     {{memviewslice_name}} * tmpslice,
                     char
order,
int
ndim) nogil except NULL:
"""
...
cdef int memoryview_copy_contents({
{memviewslice_name}} src,
                     {{memviewslice_name}}
dst,
int
...
dst_ndim,
bint
dtype_is_object) nogil except -1:
"""
...
cdef void refcount_copying({
{memviewslice_name}} *dst, bint
dtype_is_object,
int
ndim, bint
inc) nogil:
...
{memviewslice_name}} *dst, int
ndim,
size_t
itemsize, void * item,
bint
dtype_is_object) nogil:
refcount_copying(dst, dtype_is_object, ndim, False)
