...
class Query(BaseQuery):
    ...
    def addinstcounter(self, object, counter, machine=None, objtype='Process', volatile=1,
        ...
        for path in paths:
            try:
                ...
                self.curpaths.append(
                    path)  # if we fail on the line above, this path won't be in the table or the counters
            except win32api.error:
