...
class HierDialog(dialog.Dialog):
    def __init__(self, title, hierList, bitmapID=win32ui.IDB_HIERFOLDERS, dlgID=win32ui.IDD_TREE, dll=None,
...
class HierList(object.Object):
    def __init__(self, root, bitmapID=win32ui.IDB_HIERFOLDERS, listBoxId=None,
                 bitmapMask=None):  # used to create object.
    ...
    def AddItem(self, parentHandle, item, hInsertAfter=commctrl.TVI_LAST):
        ...
        hitem = self.listControl.InsertItem(parentHandle, hInsertAfter,
