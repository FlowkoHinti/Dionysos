...
class DockingBar(window.Wnd):
    ...
    def CreateWindow(self, parent, childCreator, title, id,
                     style=win32con.WS_CHILD | win32con.WS_VISIBLE | afxres.CBRS_LEFT, childCreatorArgs=()):
    ...
    def OnNcCalcSize(self, bCalcValid, size_info):
        ...
        if self.nDockBarID == afxres.AFX_IDW_DOCKBAR_TOP:
            ...
            self.rectBorder = self.rectBorder[0], self.rectBorder[3] - self.cxEdge, self.rectBorder[2], self.rectBorder[
                3]
            ...
            rc0.right = rc0.right - self.cxBorder
            self.rectBorder = self.rectBorder[0], self.rectBorder[1], self.rectBorder[2], self.rectBorder[
                1] + self.cxEdge
            ...
            self.rectBorder = self.rectBorder[2] - self.cxEdge, self.rectBorder[1], self.rectBorder[2], self.rectBorder[
                3]
            ...
            rc0.bottom = rc0.bottom - self.cxBorder
            rc0.top = rc0.top + self.cxGripper
            self.rectBorder = self.rectBorder[0], self.rectBorder[1], self.rectBorder[0] + self.cxEdge, self.rectBorder[
                3]
        else:
