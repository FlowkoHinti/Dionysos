    ...
    if not pathName or bShowDialog:
        ...
        if debuggingType == RS_DEBUGGER_GO and debugger is not None:
            ...
            if rd is not None and len(rd.breaks) == 0:
                ...
                rc = win32ui.MessageBox(msg, win32ui.LoadString(win32ui.IDR_DEBUGGER),
...
def ImportFile():
    ...
    try:
        ...
        win32ui.SetStatusText(
            'Successfully ' + what + "ed module '" + modName + "': %s" % getattr(mod, '__file__', "<unkown file>"))
    except:
...
def FindTabNanny():
    ...
    try:
        path = win32api.RegQueryValue(win32con.HKEY_LOCAL_MACHINE,
