...
class TheDocument(docview.RichEditDoc):
    ...
    def OnNewDocument(self):
        ...
        d = TheDialog(self.dirpattern, self.filpattern, self.greppattern, self.casesensitive, self.recurse,
                      self.verbose)
...
class TheDialog(dialog.Dialog):
    def __init__(self, dp, fp, gp, cs, r, v):
        ...
        tmp.append(
            [EDIT, gp, 103, (52, 7, 144, 11), CS | win32con.WS_TABSTOP | win32con.ES_AUTOHSCROLL | win32con.WS_BORDER])
        ...
        tmp.append(
            [EDIT, fp, 101, (52, 33, 128, 11), CS | win32con.WS_TABSTOP | win32con.ES_AUTOHSCROLL | win32con.WS_BORDER])
