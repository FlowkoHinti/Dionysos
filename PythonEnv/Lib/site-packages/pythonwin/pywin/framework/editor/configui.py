...
from pywin.framework.editor import GetEditorOption, SetEditorOption, DeleteEditorOption, GetEditorFontOption, \
    SetEditorFontOption, defaultCharacterFormat, editorTemplate
