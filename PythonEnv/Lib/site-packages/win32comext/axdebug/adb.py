...
class Adb(bdb.Bdb, gateways.RemoteDebugApplicationEvents):
    ...
    def AttachApp(self, debugApplication, codeContainerProvider):
        ...
        self.appEventConnection = win32com.client.connect.SimpleConnection(self.debugApplication, self,
        ...
        try:
            ...
            if self.debuggingThread is None:
                ...
                if self.debuggingThread != thisThread:
                    ...
                    return
                # push our context.
                self.recursiveData.insert(0, (
                self.logicalbotframe, self.stopframe, self.currentframe, self.debuggingThreadStateHandle))
        finally:
