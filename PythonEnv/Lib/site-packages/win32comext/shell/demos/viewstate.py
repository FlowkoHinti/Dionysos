...
template_pb = shell.SHGetViewStatePropertyBag(template_pidl, "Shell", shellcon.SHGVSPB_FOLDERNODEFAULTS,
...
def update_colinfo(not_used, dir_name, fnames):
    for fname in fnames:
        ...
        if os.path.isdir(full_fname):
            ...
            pb = shell.SHGetViewStatePropertyBag(pidl, "Shell", shellcon.SHGVSPB_FOLDERNODEFAULTS,
                                                 pythoncom.IID_IPropertyBag)
            ...
            for attr in (
            'Address', 'Buttons', 'Col', 'Vid', 'WFlags', 'FFlags', 'Sort', 'SortDir', 'ShowCmd', 'FolderType', 'Mode',
            'Rev'):
