            ...
            <B>
                <TABLE BORDER=2 WIDTH=50 HEIGHT=60 CELLPADDING=1 CELLSPACING=5>
                    <CAPTION ALIGN=top><b>Calculator</b>
                        <p> </CAPTION>
                            <TR>
                                <TD COLSPAN=3 ALIGN=MIDDLE><INPUT NAME="ReadOut" TYPE="Text" SIZE=24 VALUE="0"
                                                                  WIDTH=100%></TD>
                                <TD></TD>
                            ...
                            <TR>
                                ...
                                <TD><INPUT NAME="Percent" TYPE="Button" VALUE="  % "
                                           OnClick="Operation('%', lambda x,y: x*y/100.0)"></TD>
                            </TR>
                            ...
                            <TR>
                                ...
                                <TD></TD>
                                <TD ALIGN=MIDDLE><INPUT NAME="Plus" TYPE="Button" VALUE="  +  "
                                                        OnClick="Operation('+', lambda x,y: x+y)"></TD>
                                <TD ALIGN=MIDDLE><INPUT NAME="Minus" TYPE="Button" VALUE="   -   "
                                                        OnClick="Operation('-', lambda x,y: x-y)"></TD>
                            </TR>
                            <TR>
                                ...
                                <TD></TD>
                                <TD ALIGN=MIDDLE><INPUT NAME="Multiply" TYPE="Button" VALUE="  *  "
                                                        OnClick="Operation('*', lambda x,y: x*y)"></TD>
                                <TD ALIGN=MIDDLE><INPUT NAME="Divide" TYPE="Button" VALUE="   /   "
                                                        OnClick="Operation('/', lambda x,y: x/y)"></TD>
                            </TR>
                            <TR>
                                ...
                                <TD COLSPAN=3></TD>
                                <TD><INPUT NAME="Equals" TYPE="Button" VALUE="  =  "
                                           OnClick="Operation('=', lambda x,y: x)"></TD>
                            </TR>
                </TABLE></TABLE>
        </B>
    </FORM>
