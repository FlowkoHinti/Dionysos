            ...
            try:
                ...
                while True:
                    try:
                        ...
                        self._trace("Chunk details:", idChunk, breakType, flags, locale, attr, idChunkSource,
                                    startSource, lenSource)
    ...
    def _bind_to_filter(self, fileName):
        ...
        if pythoncom.StgIsStorageFile(fileName):
            ...
            try:
                ...
                if e[
                    0] == -2147467262:  # 0x80004002: # no interface, try the load interface (this happens for some MSoft files)
